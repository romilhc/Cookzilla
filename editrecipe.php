	...
	<?php
		...
		if (!isset($_SESSION['user'])){
		  echo "Enter Username Please";
			...
			$sql =
			"SELECT recipe.rid,recipe.rtitle,recipe.desc,nos from recipe where recipe.rid=$recid";
  	...
  	<div class = "container">
  		<div class = "row">
  			<div class = "col-sm-6">
    				...
    				<input type="text" value="<?php echo $row['rtitle'];?>" class="form-control" id="retitle" name="fname" placeholder="Enter Recipe Title" required>

    				<label for="inputName" class="control-label">Description</label>
            		<textarea  class="form-control" id="desc"><?php echo $row['desc'];?></textarea>
                ...
                <?php echo $row['nos'];?>
        			...
        			<button type="button" href= "#ingredients" class="btn btn-primary" onclick="addRecipeDetails()">Next</button>	
  		...
  		<div class = "row">
  			<div class = "col-sm-6">
			        ...
			        <select class="form-control" id= "tags_choose">
      				...
      				<button type="button" href= "" class="btn btn-primary" onclick="addTags()">Add Tag</button>
  			</div>
