...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		if (!isset($_SESSION['user'])){
		  echo "Enter Username Please";
			...
			$sql = "SELECT rid,rtitle,recipe.desc,pics from recipe";
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo '<div class ="col-sm-4">  
                        ...
                        <!--Card content-->
                            ...
                            <a href="disprecipe.php?recid='.$row['rid'].'" class="btn btn-primary" onClick ="viewRec('.$row['rid'].')">View Recipe</a>
                        </div>
                        <br><br>
                      <!--/.Card content-->
                  </div>
	...
	<script>
   function viewRec(rid){

    var rrid = rid;
    //alert ("Button Pressed for "+rrid);
